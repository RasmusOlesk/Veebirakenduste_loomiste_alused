...
function App() {
  ...
  // kuias leht on üles ehitatud ja kuidas erinevad elemendid omavahel seotud on.
  //console.dir(document);

  // nüüd proovime muuta document title-i, mis on DOM-i element.
  // See on nagu veebilehe pealkiri, mis kuvatakse brausri vahekaardil.
  // document.title = "DOM-i pealkiri on muudetud"

  //nüüd proovime muuta body taustavärvi, mis on DOM-i element.
  ...
  // kasutaja nime. See võib olla kasulik, kui soovite näidata erinevate
    ...
    <>
      ...
      <section id="center">
        ...
        <p>
          ...
          võimalik teha staatiline leht dünaamiliseks. JS/TS on
          võimalik manipuleerida DOM-i, millega sab muuta sisu, struktuuri
          ja vaadet.
          <br />
          <br />
            Kui vaadate index.html, siis näete erinevaid elemente,
            mis suhtlevad DOM-iga. Näiteks div id="root" /div on koht,
            kuhu React rakendus rendertakse. Kui React rakendus käivitub,
